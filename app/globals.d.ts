declare namespace React {
	namespace JSX {
	  interface IntrinsicElements {
		...
		'dap-ds-anchor-heading': import('dap-design-system/dist/react-types').DapDSAnchorHeadingType
		...
		'dap-ds-icon': import('dap-design-system/dist/react-types').DapDSIconType
		'dap-ds-icon-eye-line': import('dap-design-system/dist/react-types').DapDSIconEyeLineType
	  }
	}
  }
